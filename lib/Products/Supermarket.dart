...
import 'package:flutter_appfinal/AItems/Item13.dart';
import 'package:flutter_appfinal/AItems/Item14.dart';
import 'dart:async';
                ...
                return Padding(
                  ...
                  child: ListView(
                    children: [
                      ...
                      Text("${modelAllproducts.products[13].title}",
                          style:
                          TextStyle(color: Colors.black, fontSize: 15,fontWeight: FontWeight.bold)),
                      Row(
                        children: [
                          ...
                          SizedBox(width: 35),
                          Text("${modelAllproducts.products[13].price}",
                              style: TextStyle(
                                  color: Colors.blue[600],
                                  fontSize: 17,
                                  fontWeight: FontWeight.bold)),
                          SizedBox(width: 5),
                          Text("${modelAllproducts.products[13].currency}",
                              style: TextStyle(
                                  color: Colors.blue[600],
                                  fontSize: 15,
                                  fontWeight: FontWeight.bold)),
                          TextButton(child: Text("Show Details",
                            ...
                            onPressed: (){
                              Navigator.of(context).push(MaterialPageRoute(builder: (context)=>Item13()));
                            },
                          )
                        ],
                      ),
                      ...
                      Stack(
                        children: [
                          Container(
                            ...
                            child: Image(
                                image: NetworkImage(
                                    modelAllproducts.products[14].avatar)),
                          ),
                          Container(
                              alignment: Alignment.center,
                              child: IconButton(
                      ...
                      SizedBox(height:10),
                      Text("${modelAllproducts.products[14].name}",
                          style:
                          TextStyle(color: Colors.black, fontSize: 15,fontWeight: FontWeight.bold)),
                      Text("${modelAllproducts.products[14].title}",
                          style:
                          TextStyle(color: Colors.black, fontSize: 15,fontWeight: FontWeight.bold)),
                      Row(
                        children: [
                          ...
                          SizedBox(width: 35),
                          Text("${modelAllproducts.products[14].price}",
                              style: TextStyle(
                                  color: Colors.blue[600],
                                  fontSize: 17,
                                  fontWeight: FontWeight.bold)),
                          SizedBox(width: 5),
                          Text("${modelAllproducts.products[14].currency}",
                              style: TextStyle(
                                  color: Colors.blue[600],
                                  fontSize: 15,
                                  fontWeight: FontWeight.bold)),
                          TextButton(child: Text("Show Details",
                            ...
                            onPressed: (){
                              Navigator.of(context).push(MaterialPageRoute(builder: (context)=>Item14()));
                            },
                          )
                        ],
                      ),
