...
class Item12 extends StatefulWidget {
  @override
  _Item12State createState() => _Item12State();
}
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    "${modelAllproducts.products[12].title}",
                                    style: TextStyle(
                                        color: Colors.black, fontSize: 20),
                                  ),
                                  Text(
                                    "${modelAllproducts.products[12].description}",
                                    style: TextStyle(
                                        color: Colors.black, fontSize: 20),
                                  ),
                                  ...
                                  Row(
                                    children: [
                                      SizedBox(width: 10),
                                      Text(
                                          "${modelAllproducts.products[12].price}",
                                          style: TextStyle(
                                      ...
                                      SizedBox(width: 10),
                                      Text(
                                          "${modelAllproducts.products[12].currency}",
                                          style: TextStyle(
                                              color: Colors.blue[600],
                                              fontSize: 20,
                                              fontWeight: FontWeight.bold)),
