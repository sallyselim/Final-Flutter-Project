...
class Item10 extends StatefulWidget {
  @override
  _Item10State createState() => _Item10State();
}
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    "${modelAllproducts.products[10].title}",
                                    style: TextStyle(
                                        color: Colors.black, fontSize: 20),
                                  ),
                                  Text(
                                    "${modelAllproducts.products[10].description}",
                                    style: TextStyle(
                                        color: Colors.black, fontSize: 20),
                                  ),
                                  ...
                                  Row(
                                    children: [
                                      SizedBox(width: 10),
                                      Text(
                                          "${modelAllproducts.products[10].price}",
                                          style: TextStyle(
                                      ...
                                      SizedBox(width: 10),
                                      Text(
                                          "${modelAllproducts.products[10].currency}",
                                          style: TextStyle(
                                              color: Colors.blue[600],
                                              fontSize: 20,
                                              fontWeight: FontWeight.bold)),
