...
class Item11 extends StatefulWidget {
  @override
  _Item11State createState() => _Item11State();
}
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    "${modelAllproducts.products[11].title}",
                                    style: TextStyle(
                                        color: Colors.black, fontSize: 20),
                                  ),
                                  Text(
                                    "${modelAllproducts.products[11].description}",
                                    style: TextStyle(
                                        color: Colors.black, fontSize: 20),
                                  ),
                                  ...
                                  Row(
                                    children: [
                                      SizedBox(width: 10),
                                      Text(
                                          "${modelAllproducts.products[11].price}",
                                          style: TextStyle(
                                      ...
                                      SizedBox(width: 10),
                                      Text(
                                          "${modelAllproducts.products[11].currency}",
                                          style: TextStyle(
                                              color: Colors.blue[600],
                                              fontSize: 20,
                                              fontWeight: FontWeight.bold)),
