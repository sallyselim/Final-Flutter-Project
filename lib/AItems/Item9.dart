...
class Item9 extends StatefulWidget {
  @override
  _Item9State createState() => _Item9State();
}
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    "${modelAllproducts.products[9].title}",
                                    style: TextStyle(
                                        color: Colors.black, fontSize: 20),
                                  ),
                                  Text(
                                    "${modelAllproducts.products[9].description}",
                                    style: TextStyle(
                                        color: Colors.black, fontSize: 20),
                                  ),
                                  ...
                                  Row(
                                    children: [
                                      SizedBox(width: 10),
                                      Text(
                                          "${modelAllproducts.products[9].price}",
                                          style: TextStyle(
                                      ...
                                      SizedBox(width: 10),
                                      Text(
                                          "${modelAllproducts.products[9].currency}",
                                          style: TextStyle(
                                              color: Colors.blue[600],
                                              fontSize: 20,
                                              fontWeight: FontWeight.bold)),
