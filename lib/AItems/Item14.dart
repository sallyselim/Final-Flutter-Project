...
class Item14 extends StatefulWidget {
  @override
  _Item14State createState() => _Item14State();
}
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    "${modelAllproducts.products[14].title}",
                                    style: TextStyle(
                                        color: Colors.black, fontSize: 20),
                                  ),
                                  Text(
                                    "${modelAllproducts.products[14].description}",
                                    style: TextStyle(
                                        color: Colors.black, fontSize: 20),
                                  ),
                                  ...
                                  Row(
                                    children: [
                                      SizedBox(width: 10),
                                      Text(
                                          "${modelAllproducts.products[14].price}",
                                          style: TextStyle(
                                      ...
                                      SizedBox(width: 10),
                                      Text(
                                          "${modelAllproducts.products[14].currency}",
                                          style: TextStyle(
                                              color: Colors.blue[600],
                                              fontSize: 20,
                                              fontWeight: FontWeight.bold)),
